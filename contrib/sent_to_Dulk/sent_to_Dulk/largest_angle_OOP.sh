...
# This script is used to select dihedral between four atoms with the largest number.
...
fileout3=open('largest_angle.log','w')
for i_geom in range(n_geom):
