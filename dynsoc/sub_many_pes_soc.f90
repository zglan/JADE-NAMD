       subroutine  sub_many_pes_soc  (n_atom, &
                                n_state, md_state, &
                                atom_label, &
      ...
      integer, intent(in) :: n_atom, qm_method, n_state, qm_package
...
!     Write the interface for QC calculations
        open(unit=102, file="qm.in")
        write (102,*)  "# The interface between DYNAMIC CODE and QC CODE"
        write (file_md_out, *) "QC Package and Theory:", qm_package, qm_method
        write (102,*)  "Time step: ", it
        ...
        ! qm_results.dat should generated by quantum.py
