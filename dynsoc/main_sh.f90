...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
       ...
       integer :: qm_method, dyn_method, qm_package
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!      file_ini_vel=12
!      open(unit=file_ini_vel, file="vel_ini.xyz")
!      call read_ini_vel (n_atom, vel_x, vel_y, vel_z, atom_label)
!      close(12)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!11
...
!       write (*,*) "Single state"
!       call  dynamics_single_pes ( n_atom, &
!                              coor_x, coor_y, coor_z, &
!                              vel_x, vel_y, vel_z, &
!                              atom_label, i_state, &
!                              ntime, dtime, &
