...
class mndo_run:
    ...
    def __init__(self, label_ZN, config = {}):
        ...
        """
        self.directory = {"qc": "./QC_TMP", "work": "./QC_TMP/MNDO_TMP", "home": "./QC_TMP" }
        self.files = {"template": "template.json", "interface": "interface.json","map": "imomap.dat"}
        self.config = config
...
#        proc = subprocess.Popen("mndo99 < mndo.inp > mndo.log", shell=True)
    ...
    def analyze(self):
        ...
        """
        mndo = mndo_parser(self.label_ZN, self.config)        
