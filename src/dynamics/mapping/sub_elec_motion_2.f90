subroutine sub_elec_motion_2(x_mode_cur, p_mode_cur, &
...
! half step of p
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  call sub_elec_get_dH_div_dx_or_dp(n_state, Ham, x_elec, dH_div_dx)
...
! one step of x
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  call sub_elec_get_dH_div_dx_or_dp(n_state, Ham, p_elec, dH_div_dp)
