subroutine sub_nuc_motion_Ham_4_aver_PES( x_mode, p_mode, &
                           c_n, &
                           freq, k_tun, exci_e, &
                           lambda0, lambda1, &
...
call sub_nuc_get_dH_div_dX_or_dP_aver_PES(c_n, dHmn_div_dX, &
                       dH_div_dX)
...
call sub_nuc_get_dH_div_dP_aver_PES(n_mode_HO, n_state, &
                               x_mode(1:n_mode_HO), &
                               p_mode(1:n_mode_HO), &
                               freq,  &
                               dH_div_dP(1:n_mode_HO))

call sub_nuc_get_dH_div_dP_aver_PES(n_mode_tor, n_state, &
                               x_mode(n_mode_HO+1:n_mode), &
